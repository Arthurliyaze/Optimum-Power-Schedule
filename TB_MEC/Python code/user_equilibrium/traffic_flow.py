"""This python file defines a traffic flow model class
to calculate the ue traffic flow.
Created by Zheng Li.
Modified by Yaze Li, University of Arkansas 05/22/2023"""
...
class TrafficFlowModel:
    ...
    def solve(self, blockprint=False):
