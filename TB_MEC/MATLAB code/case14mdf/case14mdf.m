function mpc = case14mdf
%CASE14MDF Power flow data for modified IEEE 14 bus case.
%   This case is converted from case 14 Matpower data.
%   by Yaze Li, University of Arkansas
%% MATPOWER Case Format : Version 2
mpc.version = '2';

%%-----  MPOPF Data  -----%%
%% Profile parameters
mpc.essSite = [3,6,8,11];
mpc.essSize = [1,1,1,1]; % MWh
mpc.loadSite = [2,3,4,5,6,9,10,12,13];
mpc.renewSite = [3,6,8,11];
...
mpc.gen = [
	1	232.4	-16.9	10	0	1.06	100	1	332.4	0	0	332.4	-8.5	330     -0.5	320	20  20	20	170	0;
	2	40      42.4	50	-40	1.045	100	1	140     0	0	140     -48.5	136.5	-38.5	125	35	35	35	170	0;
	3	0       23.4	40	0	1.01	100	1	100     0	0	100     -38.5	97.5	-28.5	87	25	25	25	80	0;
	6	0       12.2	24	-6	1.07	100	1	100     0	0	100     -23.5	97.5	-12.5	87	30	30	30	80	0;
	8	0       17.4	24	-6	1.09	100	1	100     0	0	100     -23.5	97.5	-12.5	87	3	3	3	77.5	0;
];
